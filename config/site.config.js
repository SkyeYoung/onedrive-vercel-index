...
module.exports = {
  ...
  icon: process.env.NEXT_PUBLIC_ICON || '/icons/128.png',
  ...
  baseDirectory: process.env.NEXT_PUBLIC_BASE_DIR || '/Public',
  ...
  footer:
    process.env.NEXT_PUBLIC_FOOTER || 'Powered by <a href="https://github.com/spencerwooo/onedrive-vercel-index" target="_blank" rel="noopener noreferrer">onedrive-vercel-index</a>. Made with ❤ by SpencerWoo.',
